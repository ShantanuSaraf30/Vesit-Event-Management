...
button3 = tk.Button(frame, text="B21", bg="red")
button3.grid(row=1, column=16, padx=10, pady=10)
button4 = tk.Button(frame, text="B22",bg="red")
...
button5 = tk.Button(frame, text="B31", bg="red")
button5.grid(row=2, column=16, padx=10, pady=10)
button6 = tk.Button(frame, text="B32", bg="red")
...
button10 = tk.Button(frame, text="412",bg="red")
button10.grid(row=3, column=11, padx=10, pady=10)
...
home_button = tk.Button(frame, text="Home", command=home, bg="lightblue")
home_button.grid(row=5, column=8, sticky="NE", padx=10, pady=10)

select_button = tk.Button(frame, text="Select", command=select, bg="lightblue")
